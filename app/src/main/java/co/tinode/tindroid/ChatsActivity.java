...
public class ChatsActivity extends AppCompatActivity
        ...
        if (fragment == null) {
            switch (tag) {
                ...
                case FRAGMENT_AVATAR_PREVIEW:
                    ...
                    // Avatar mód és default 'me' topik
                    args.putBoolean(AttachmentHandler.ARG_AVATAR, true);
                    if (TextUtils.isEmpty(args.getString(Const.INTENT_EXTRA_TOPIC))) {
    ...
    public void onAcceptAvatar(String topicName, Bitmap avatar) {
        if (isDestroyed() || isFinishing() || avatar == null) {
            return;
        }
        // Személyes profilkép: mindig a 'me' topikra frissítünk.
